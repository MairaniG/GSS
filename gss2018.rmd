...
WORDSUM is a categorical variable and DEGREE is also a categorical variable, so I use the cat-cat helper file.
...
The barcharts show that the highest scorers (score 12) on the WORDSUM test have a higher education. People that have a bachelors degree typically score higher.
...
The table shows that there is a relationship between a persons score on the WORDSUM test and their level of education. <!--Numerical results go here. Use the numerical results to describe the patterns if any that exist in the data as focused toward the research question!-->
